import FormUpdateTask from "../../FormUpdateTask/index";
import CardBase from "../CardBase";
import { Container } from "./styles";

export default function SeeTask({ isShown, setSeeTask, task, unabled }) {
  return (
    <CardBase isShown={isShown}>
      <Container>
        <div className="new-task-top">
          <span>{!unabled && "Editar as informações da tarefa"}</span>
          <svg
            width="15"
            height="15"
            viewBox="0 0 18 17"
        ...
        <FormUpdateTask task={task} unabled={unabled} />
      </Container>
    </CardBase>
  );
}
