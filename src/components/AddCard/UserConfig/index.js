...
export default function UserConfig() {
  ...
  return (
    <CardBase isShown={showUserConfig} setIsShown={setShowUserConfig}>
      <Portal absolute="true" isOpen={isOpenUser} setIsOpen={setIsOpenUser}>
        <label>Adicionar novo utilizador</label>
        <FormNewUser />
      </Portal>
      <Container>
        <div className="config-task-top">
          <div className="label">
            ...
            <span>Configurações de utilizador</span>
          </div>
          <svg
            width="15"
            height="15"
        ...
        <List>
          <div className="form-group first-group">
            <div className="config-section">
              <label>Lista de utilizadores</label>
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
