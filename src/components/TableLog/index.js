import { Box, Menu, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TableSortLabel } from '@mui/material';
...
export default function EnhancedTable({ logs }) {
  const {
    actionDone,
    setActionDone,
    setLoading,
